...
if __name__ == '__main__':
    ...
    sampleSize = int(input("What would you like the sample size to be? (we recommend 5-10 because of runtime issues) "))
    ...
    # If you would rather score a specific word, run this code:
